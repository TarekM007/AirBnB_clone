...
class TestPlace_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        ...
        p.middle_name = "Hawai"
        p.my_number = 98
        self.assertEqual("Hawai", p.middle_name)
    ...
    def test_to_dict_output(self):
        ...
        p = Place()
        p.id = "333444"
        p.created_at = p.updated_at = my_date
        t_dict = {
            'id': '333444',
            '__class__': 'Place',
        ...
        self.assertDictEqual(p.to_dict(), t_dict)
